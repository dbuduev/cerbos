...
const file_authzen_authorization_v1_svc_proto_rawDesc = "" +
	"\n" +
	"\"authzen/authorization/v1/svc.proto\x12\x18authzen.authorization.v1\x1a)authzen/authorization/v1/evaluation.proto\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto2\xe6\x02\n" +
	"\x14AuthorizationService\x12\x92\x02\n" +
	"\bEvaluate\x12+.authzen.authorization.v1.EvaluationRequest\x1a,.authzen.authorization.v1.EvaluationResponse\"\xaa\x01\x92A\x86\x01\x12\x17Evaluate access request\x1aaEvaluate whether a subject can perform an action on a resource according to AuthZEN specification*\bEvaluate\x82\xd3\xe4\x93\x02\x1a:\x01*\"\x15/access/v1/evaluation\x1a9\x92A6\x124AuthZEN Authorization Service for access evaluationsB\xcd\x02\x92A\xbb\x01\x12\x91\x01\n" +
...
var file_authzen_authorization_v1_svc_proto_depIdxs = []int32{
	0, // 0: authzen.authorization.v1.AuthorizationService.Evaluate:input_type -> authzen.authorization.v1.EvaluationRequest
	1, // 1: authzen.authorization.v1.AuthorizationService.Evaluate:output_type -> authzen.authorization.v1.EvaluationResponse
