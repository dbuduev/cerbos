...
type ResourcePolicy struct {
	...
	Aliases            map[string]string `protobuf:"bytes,5,rep,name=aliases,proto3" json:"aliases,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *ResourcePolicy) GetAliases() map[string]string {
	if x != nil {
		return x.Aliases
	}
	return nil
...
var file_cerbos_policy_v1_policy_proto_rawDesc = []byte{
	...
	0x12, 0x47, 0x0a, 0x07, 0x61, 0x6c, 0x69, 0x61, 0x73, 0x65, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28,
	...
	0x69, 0x63, 0x79, 0x2e, 0x41, 0x6c, 0x69, 0x61, 0x73, 0x65, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79,
	0x52, 0x07, 0x61, 0x6c, 0x69, 0x61, 0x73, 0x65, 0x73, 0x1a, 0x3a, 0x0a, 0x0c, 0x41, 0x6c, 0x69,
...
var file_cerbos_policy_v1_policy_proto_goTypes = []interface{}{
	...
	nil,                            // 16: cerbos.policy.v1.ResourcePolicy.AliasesEntry
...
var file_cerbos_policy_v1_policy_proto_depIdxs = []int32{
	...
	16, // 6: cerbos.policy.v1.ResourcePolicy.aliases:type_name -> cerbos.policy.v1.ResourcePolicy.AliasesEntry
